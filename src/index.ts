...
const person2 = { person: 'James T. Kirk', details: 'captain of the USS Enterprise' };
const num_turns = 2;
...
let conversation_starter = 'What is the average airspeed velocity of an unladen swallow?';
